    ...
    >
      <div className="absolute -left-4 md:-left-20 top-3">
        <motion.div
          ...
          className="ml-[27px] h-4 w-4 rounded-full border border-zinc-700 bg-zinc-900 shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{
              duration: 0.2,
            ...
            className="h-2 w-2 rounded-full border border-zinc-700 bg-zinc-900"
          />
        </motion.div>
        <svg
